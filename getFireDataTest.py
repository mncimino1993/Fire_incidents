...
print("This will run every minute -- %s"%(now.strftime("%Y-%m-%d %H-%M-%S")))
...
# # In[6]:
# engine = create_engine('postgresql://pgadmin:thisIsASecurePassword33!@172.18.0.2:5432/postgres',pool_pre_ping=True)
# start = 0
# chunkSize = 20000
...
#     print('Dataframe has ',dfCount, ' records')
#     if (start == 0 ):
...
#     if (start > int(recordCount[0]['COUNT']) ):
#         break    
